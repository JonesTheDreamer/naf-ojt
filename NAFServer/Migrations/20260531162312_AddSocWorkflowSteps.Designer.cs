...
namespace NAFServer.Migrations
{
    ...
    [Migration("20260531162312_AddSocWorkflowSteps")]
    partial class AddSocWorkflowSteps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NAFServer.src.Domain.Entities.AuditTrail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NAFServer.src.Domain.Entities.Location", b =>
                {
                    ...
                    b.Property<bool>("AllowWeekendDateNeeded")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("NAFServer.src.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("NAFServer.src.Domain.Entities.ResourceRequestAllowance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResourceId", "LocationId")
                        .IsUnique();

                    b.ToTable("ResourceRequestAllowances");
                });
